  ...
  private static createDefault(): PortfolioRepository {
    ...
    const projects = [
      new Project(
        'larp-music',
        'Larp Music',
        'Cliente web y móvil · PWA + Android',
        'App de streaming musical propia: web, PWA instalable y APK Android con la misma base de código.',
        'Larp Music es un cliente React empaquetado con Vite, desplegado como PWA en music.josmargalindo.com y distribuido en Android mediante Capacitor. Consume una API propia (Node.js + SQLite en Raspberry Pi vía Cloudflare Tunnel) e implementa reproductor con cola, playlists colaborativas, modo offline cifrado, widgets sociales nativos en Android y dos sistemas de diseño en paralelo (Material 3 y Cupertino).',
        ASSET('larp-music.png'),
        '#',
        'https://music.josmargalindo.com/#/',
        ['React', 'Vite', 'Capacitor', 'PWA', 'Workbox', 'Android'],
        'featured',
        true,
      ),
      new Project(
